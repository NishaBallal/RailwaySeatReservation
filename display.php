...
$tnum=isset($row['Tnumber']);
$cl=isset($row['class']);
$tname=isset($row['Name']);
		...
		<div class="span12 well">
			...
			<div >
				...
				<tr>
					...
					<th style="width:100px;border-top:0px;">Cancel Ticket</th>
				</tr>	
				<?php
				...
				<tr class="text-error">
					...
					<th style="width:100px;"> <a href="cancel.php?Tnumber=<?php echo $row['Tnumber'];?>">Click Here </a></th>
